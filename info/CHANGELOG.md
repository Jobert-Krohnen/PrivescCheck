...
- Refactor and clean up Main.ps1 completely.
...
- Check TPM Core Provisioning procedure existence before trying to call them to avoid unexpected exceptions (issue #80).
